...
A development version server is provided in this repository. It can be run locally using Docker Compose.
...
This development server is pre-configured with a realm named `rtl433dp`. Details of the realm can be found in the 
